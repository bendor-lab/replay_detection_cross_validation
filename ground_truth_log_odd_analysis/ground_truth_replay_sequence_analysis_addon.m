function [] = ground_truth_replay_sequence_analysis_addon(folders,BAYSESIAN_NORMALIZED_ACROSS_TRACKS)
...
%     shuffle_type{6}.shuffled_track = ground_truth_parallel_shuffles(shuffle_choice,analysis_type,num_shuffles,decoded_replay_events,place_fields_BAYESIAN,BAYSESIAN_NORMALIZED_ACROSS_TRACKS);
...
%     shuffle_type1{6}.shuffled_track = parallel_shuffles(shuffle_choice,analysis_type,num_shuffles,decoded_replay_events1);
    shuffle_type1{6}.shuffled_track = ground_truth_parallel_shuffles(shuffle_choice,analysis_type,num_shuffles,decoded_replay_events1,place_fields_BAYESIAN,BAYSESIAN_NORMALIZED_ACROSS_TRACKS);

%     shuffle_type2{6}.shuffled_track = parallel_shuffles(shuffle_choice,analysis_type,num_shuffles,decoded_replay_events2);
    shuffle_type2{6}.shuffled_track = ground_truth_parallel_shuffles(shuffle_choice,analysis_type,num_shuffles,decoded_replay_events2,place_fields_BAYESIAN,BAYSESIAN_NORMALIZED_ACROSS_TRACKS);
