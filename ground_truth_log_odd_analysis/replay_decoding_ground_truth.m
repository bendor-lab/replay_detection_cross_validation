...
function decoded_replay_events = replay_decoding_ground_truth(BAYSESIAN_NORMALIZED_ACROSS_TRACKS)
    ...
    disp('Spike count...');
    replayEvents_bayesian_spike_count = spike_count([],replay_starts,replay_ends,'N'); 
    save replayEvents_bayesian_spike_count replayEvents_bayesian_spike_count

    % Run bayesian decoding
    disp('Decoding position...');
    % Only normalized within a track   
    estimated_position = bayesian_decoding_ground_truth([],'replayEvents_bayesian_spike_count',[],BAYSESIAN_NORMALIZED_ACROSS_TRACKS,'N')
