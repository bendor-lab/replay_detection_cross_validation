function [multi_event_percent multi_event_number] = calculate_multitrack_event_percentage(session_index,event_index,track_1_index,track_2_index)
% 
...
multi_event_percent = sum(multitrack_event)...
    /(length(track_1_index)+length(track_2_index) - sum(multitrack_event));
